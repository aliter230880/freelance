...
function Hero() {
  return (
    <section className="relative min-h-[92vh] flex items-center border-b border-white/[0.06] overflow-hidden">
      ...
      {/* Particle sphere layer — kept inside Hero, positioned between headline and ledger card */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute right-[2%] top-[-10%] h-[115%] w-[70%] max-w-[1100px]">
          <ThreeCanvas
            distortion={0.65}
            detail={0.95}
            speed={0.12}
